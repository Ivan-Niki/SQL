...
/* Вывести группы супергероев по типу (align) и для каждой группы подсчитать общее количество супергероев в группе, а также сумму появлений супергероев этого типа  */
