...
Например, в примере выше в таблицах Teachers и Students по три столбца.
--> Типы данных столбцов должны быть одинаковыми. 
Например, в примере выше столбец age в таблице Teachers является целочисленного типа данных, как и столбец age в таблице Students.
--> Столбцы должны находится в одинаковом порядке в каждой таблице. 
Например, в примере выше порядок столбцов в таблице Teachers — id-name-age, как и в таблице Students. */
